object AndroidX {
    ...
    private const val activityLifycecleRuntimeKtxVerion = "2.6.2"
    const val activityLifycycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:$activityLifycecleRuntimeKtxVerion"
